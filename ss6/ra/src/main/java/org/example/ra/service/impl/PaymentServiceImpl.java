...
public class PaymentServiceImpl implements PaymentService {
    ...
    public APIDataResponse<Page<BookingRevenueDTO>> getBookingRevenue(int page, int size, LocalDateTime paidAt) {
        Page<Object[]> result = paymentRepository.findAmountByPaidAt(PageRequest.of(page, size), paidAt);
